...
def dummyposetrain():
    ...
    os.chdir(r"C:\\Users\\sreya\\Desktop\\images")
    img_dir = os.getcwd()
    ...
    # train_y_coordinates = open("C:\\Users\\sreya\\Desktop\\yolo-object-detection\\train_y_coordinates.txt", "a")
    all_file = os.listdir(img_dir)
    # os.chdir(r"C:\\Users\\sreya\\Desktop\\gait-recognition-master")
    for file in all_file:
        if file.endswith(".jpg"):
            skeleton(file)
    #print(ranklelist,lanklelist)
    # Plotting the unique points/lengths
    os.mkdir("C:/Users/sreya/Desktop/TrainData/"+str(inputValue))
    print("Processing fft..")
    for i in range(len(jointll)):
        jointll[i]=[x.real for x in fft(jointll[i])]
        print("Creating "+strjoint[i]+".txt")
        txtfile=open("C:/Users/sreya/Desktop/TrainData/"+str(inputValue)+"/"+strjoint[i]+".txt","w")
...
def compare_points():
    ...
    train_folders = os.listdir("C:/Users/sreya/Desktop/TrainData")
    testlist = dummyposetest()  # list of lists
    
    for i in train_folders:
        joint_files = os.listdir("C:/Users/sreya/Desktop/TrainData/" + str(i))
        countlist,errorlist= [],[]
        num = 0  # just a counter for testlist
        for j in joint_files:
            count, countlist = 0, []
            file = open("C:/Users/sreya/Desktop/TrainData/" + str(i) + "/" + str(j), "r")
...
def v2f():
    ...
    video=os.listdir("C:\\Users\\sreya\\Desktop\\videos")
    cam = cv2.VideoCapture("C:/Users/sreya/Desktop/videos/"+str(video[0]))
    ...
    while currentframe < frame_count:
        ...
        if ret:
            ...
            name = 'C:/Users/sreya/Desktop/images/' + str(currentframe) + '.jpg'
            print('Creating...' + name)
    ...
    os.remove("C:/Users/sreya/Desktop/videos/"+str(video[0]))
from tkinter import *
...
inputValue=0
def opentraining():
    os.system("start C:\\Users\\sreya\\Desktop\\videos")
    while os.listdir("C:\\Users\\sreya\\Desktop\\videos")==[]:
        continue
    v2f()

"""def detect():
    os.system("python test_yolo.py --image images --yolo yolo-coco")"""
...
# command=lambda: retrieve_input() >>> just means do this when i press the button
    ...
    label.pack()
def newwindow1():
    os.system("start C:\\Users\\sreya\\Desktop\\face_rec")
...
filename1 = PhotoImage(file="C:/Users/sreya/Desktop/pes-logo.png")
background_label1 = Label(frame, image=filename1)
background_label1.place(x=0, y=0, relwidth=0.32, relheight=0.20)
filename2 = PhotoImage(file="C:/Users/sreya/Desktop/CDSAML1.png")
background_label2 = Label(frame, image=filename2)
background_label2.place(x=340, y=0, relwidth=0.32, relheight=0.20)
# c.pack()
...
button6 = Button(frame, text="FACE RECOGNITION\n(beta phase)", fg="black", font=("Ariel", 9, "bold"), bg="cyan", command=newwindow1)
...
button6.place(relheight=0.10, relwidth=0.332, relx=0.5, rely=0.8, anchor=CENTER)
